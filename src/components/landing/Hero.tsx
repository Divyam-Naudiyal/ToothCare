...
function Hero() {
  return (
    ...
    <section className="relative h-screen flex items-center overflow-hidden pt-20 bg-[#0c0c1d]">
  {/* Background gradient */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Interact with our AI dental assistant for instant guidance, smart appointment 
                  scheduling, and personalized care tips—available around the clock.
                </p>
              </div>
            ...
            <div className="relative lg:pl-8">
              {/* GRADIENT ORBS */}
              <div className="absolute -top-1 -left-4 w-24 h-24 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl rotate-45 blur-xl"></div>
