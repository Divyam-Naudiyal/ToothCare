        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10">
                ...
                <span className="text-xs font-medium text-primary">Your Time, Your Pace</span>
              </div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Join 1,500+ patients who trust our AI for instant guidance and personalized care.
              </p>
            </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              {/* Floating Badge */}
              <div className="absolute -top-4 left-4 bg-gradient-to-r from-green-500/90 to-[#00ffcc] backdrop-blur-sm text-black px-3 py-1 rounded-full text-xs font-medium shadow-lg z-10">
