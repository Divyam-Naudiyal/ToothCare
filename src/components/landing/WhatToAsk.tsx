        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6">
              <MessageCircleIcon className="w-4 h-4 text-primary" />
               <span className="text-sm font-medium text-primary">AI-Driven Interactions</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Our AI handles everything from straightforward questions to intricate dental concerns, with insights from thousands of real cases.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
               <h3 className="text-2xl font-bold mb-8">Frequently Asked Questions Answered by Our AI:</h3>
